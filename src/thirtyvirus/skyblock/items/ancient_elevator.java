...
public class ancient_elevator extends UberItem {
    ...
    private String default_description = "Manual Operation";
    private LocalDateTime time = LocalDateTime.now();

    public ancient_elevator(Material material, String name, UberRarity rarity, boolean stackable, boolean oneTimeUse, boolean hasActiveEffect, List<UberAbility> abilities, UberCraftingRecipe craftingRecipe) {
    ...
    public void getSpecificLorePrefix(List<String> lore, ItemStack item) {
        ...
        String description = Utilities.getStringFromItem(item, "description");
