...
public class kloonboat extends UberItem {

    private String default_to = "" + ChatColor.RED + "[" + ChatColor.WHITE + "YOUTUBE" + ChatColor.RED + "] thirtyvirus";
    private String default_from = "" + ChatColor.RED + "[ADMIN] Minikloon";
    private int default_edition = 1;
    private LocalDateTime time = LocalDateTime.now();

    public kloonboat(Material material, String name, UberRarity rarity, boolean stackable, boolean oneTimeUse, boolean hasActiveEffect, List<UberAbility> abilities, UberCraftingRecipe craftingRecipe) {
    ...
    public void getSpecificLorePrefix(List<String> lore, ItemStack item) {
        ...
        lore.add("" + ChatColor.RESET + ChatColor.GRAY + "Drop this item to decrease your FPS.");
        lore.add("" + ChatColor.RESET + ChatColor.DARK_GRAY + "Immune to dropping.");
        lore.add("");
