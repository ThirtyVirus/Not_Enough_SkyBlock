...
public class zombie_sword extends UberItem {
    ...
    public boolean clickedInInventoryAction(Player player, InventoryClickEvent event, ItemStack item, ItemStack addition) {
        ...
        if (UberItems.getMaterial("golden_powder").compare(addition)) {
            Utilities.applyUpgrade(player, event, item, "Ornate", "Grants an extra charge (doesn't do anything yet lol)");
