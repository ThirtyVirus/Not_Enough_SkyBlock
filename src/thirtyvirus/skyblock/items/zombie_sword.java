...
public class zombie_sword extends UberItem {
    ...
    public zombie_sword(Material material, String name, UberRarity rarity, boolean stackable, boolean oneTimeUse, boolean hasActiveEffect, List<UberAbility> abilities, UberCraftingRecipe craftingRecipe, String raritySuffix) {
    ...
    public boolean rightClickAirAction(Player player, ItemStack item) {
        ...
        if (Utilities.enforceManaCost(player, 35)) return false;
