...
public class hoe_of_great_tilling extends UberItem {
    ...
    public hoe_of_great_tilling(Material material, String name, UberRarity rarity, boolean stackable, boolean oneTimeUse, boolean hasActiveEffect, List<UberAbility> abilities, UberCraftingRecipe craftingRecipe) {
